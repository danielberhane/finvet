...
class TestStateOwnership:
    ...
    _EXTERNALLY_CONSUMED = {
        ...
        "agent_evidence": "confidence adjuster, guardrails, response",
        "agent_type": "audit agents_run",
        "verdict": "confidence adjuster -> guardrails -> response",
        "confidence": "confidence adjuster -> guardrails -> response",
